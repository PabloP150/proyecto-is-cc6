...
class RecommendationsAgent:
    ...
    def _build_comprehensive_plan_prompt(self, message: str, clarifications: str = ""):
        ...
        return (
            ...
            f"CRITICAL DATE CONTEXT: Today's date is {date.today().strftime('%B %d, %Y')}. All generated dates (start dates, end dates, deadlines) MUST be in the future relative to this date.\n\n"
